package org.opennms.netmgt.abcbank;
...
/**
 * Created by laiguanhui on 2016/3/23.
 */
public class TestSNMP {
        ...
        public static void main(String[] args) {
            ...
            try {
                ...
                manager.sendMessage(false, true, pdu, "udp:172.16.3.1/161");//192.168.1.233 WinServer2008服务器
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
