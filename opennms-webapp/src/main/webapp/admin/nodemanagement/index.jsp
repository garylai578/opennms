...
<div class="TwoColRAdmin">
  ...
  <p>
    <b>配置接口和服务</b>允许您更改你的系统配置，随着网络变化。
    当本系统首次启动，在网络中的节点，接口，和服务服务会<em>自动发现</em>或通过一个或多个的<em>设备配置导入</em>添加。随着网络的增长和变化，你要管理的TCP/IP范围，以及在这些范围内的接口和服务可能会修改。对于设备配置导入的节点，最好是修改设备配置导入，而不是修改以下选项。当有大量的节点管理时，最好通过灵活的设备配置导入来自动管理。
  </p>
