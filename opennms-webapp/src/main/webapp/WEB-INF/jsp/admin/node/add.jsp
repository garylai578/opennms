...
<div class="TwoColRight">
	...
	<div class="boxWrapper">
		<p>
		这个工作流程提供了一个快速的方法对添加现有的设备配置导入到系统。
		</p>
		...
		<p>
		<em>基本属性</em>是所有节点公用的。
		选择一个设备配置导入添加节点，提供一个IP地址给系统进行通信，然后输入一个节点名称。
		节点名称将作为节点在系统的显示名称。
		</p>

		<p>
		<em>监视分类成员</em>是可选的标签。
		一个节点可以加入多个监视分类，这些分类的名称在系统是非常有用的。
		</p>

		<p>
		<em>SNMP参数</em>是可选的并且只应用于节点初始的设备配置导入。
		如果在这里没有指定值，系统将使用<em>基本属性</em>配置。
		如果节点不支持SNMP，应该选中"No SNMP"。
		Web UI不支持SNMP V3参数配置；如果要配置节点SNMPV3参数请联系你的系统管理员。
		</p>
